package bjfu.it.panjue.mirrormusic.services;
...
import bjfu.it.panjue.mirrormusic.activities.WelcomeActivity;
...
public class MusicService extends Service {
    ...
    public class MusicBind extends Binder {
        ...
        public int getDuration() {
            return  mMediaPlayerHelp.getDuration();
        }

        //获取当前位置
        public int getCurrentPosition() {
            return  mMediaPlayerHelp.getCurrentPosition();
        }
