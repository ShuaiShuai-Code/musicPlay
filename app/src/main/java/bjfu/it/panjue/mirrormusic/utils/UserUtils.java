...
import bjfu.it.panjue.mirrormusic.activities.LoginActivity;
import bjfu.it.panjue.mirrormusic.helps.RealmHelp;
import bjfu.it.panjue.mirrormusic.helps.UserHelp;
import bjfu.it.panjue.mirrormusic.models.UserModel;
...
public class UserUtils {
    ...
    public static boolean registerUser(Context context, String phone, String password, String passwordConfirm){
        ...
        /*
            ...
            2.根据用户输入的手机号匹配查询的所有用户，如果可以匹配则证明该手机号已被注册，否则则没有被注册
         */
        if(UserUtils.userExistFromPhone(phone)){
    ...
    /*
        ...
        (3)原密码输入是否正确
           a.Realm获取当前登录的用户模型
           b.根据用户模型中保存的密码匹配用户原密码
        2.利用Realm模型自动更新特性完成密码的修改
     */
